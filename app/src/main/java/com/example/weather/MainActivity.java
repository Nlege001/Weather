...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeRL = findViewById(R.id.relativeLayout1);
        loadingPR = findViewById(R.id.ProgressBar);
        ...
        weatherRV = findViewById(R.id.weather_recycler);

        weatherDataClass = new ArrayList<>();
        weatherAdapter = new WeatherAdapter(this, weatherDataClass);
    ...
    private  void getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=6bfa0933b08b4cf8b89205952221902&q="+ cityName +"&days=1&aqi=no&alerts=no";
        cityNameTV.setText(cityName);
